...
A standard method for dealing with constraints in deterministic inequality-constrained optimization problems like
\eqref{eq:general-constrained-problem} with $h\equiv 0$, involves the use of a \textit{penalty functions}
