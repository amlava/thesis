...
\begin{equation*}
    ...
    \end{aligned}
\end{equation*}
Our method naturally handles the case where there are infinitely many nonlinear constraints,
...
without the need of a global variance bound on the stochastic gradients, while also being applicable to nonlinear constraints.
Further, it is known that stochastic projected gradient descent achieves the minimax optimal convergence rates of
...
\cite{campi2011sampling}. However, this is only and approximation and further
requires the ability to sample
a possibly very large amount of times. This is not always feasible, for example,
...
which is unrealistic in the online context.
