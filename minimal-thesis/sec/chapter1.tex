...
and $b(z)\in\R^m$. We assume that $\E(F_\xi)\colon\R^n\to\R$ is $\mu$-strongly convex and $L$-smooth, and
that $r\colon\R^n\to\R$ is convex (but possibly nonsmooth). Examples of these problems
